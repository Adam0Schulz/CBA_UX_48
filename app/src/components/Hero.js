    ...
    <div className="hero">
      <div className="hero-content">
        <Link to="/" className="hero-logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 181 181" className="fog-logo">
            <path fill="#013d7a" d="M-2-2h183v183H-2z"></path>
            ...
            <path fill="#FFF" d="M152.87 61.4a5.12 5.12 0 0 0-2.86-2.82 5.93 5.93 0 0 0-2.21-.4 5.59 5.59 0 0 0-2.17.42 5.25 5.25 0 0 0-2.92 2.86 5.16 5.16 0 0 0-.43 2.12c-.01.74.13 1.475.41 2.16a5 5 0 0 0 1.13 1.7 5.23 5.23 0 0 0 1.73 1.13 5.91 5.91 0 0 0 2.2.4 5.51 5.51 0 0 0 2.16-.42 5.42 5.42 0 0 0 1.76-1.15 5.38 5.38 0 0 0 1.6-3.85 5.62 5.62 0 0 0-.4-2.15m-1.16 3.88a4.21 4.21 0 0 1-.86 1.34 4.11 4.11 0 0 1-1.34.92 4.72 4.72 0 0 1-3.43 0 3.88 3.88 0 0 1-1.34-.89 4.21 4.21 0 0 1-.89-1.34 4.32 4.32 0 0 1-.32-1.68 4.21 4.21 0 0 1 .32-1.65 4.08 4.08 0 0 1 .89-1.34 4.11 4.11 0 0 1 1.34-.89 4.32 4.32 0 0 1 1.68-.32 4.21 4.21 0 0 1 1.65.32 4.08 4.08 0 0 1 1.34.89 4.21 4.21 0 0 1 .89 1.34 4.32 4.32 0 0 1 .32 1.68 4.21 4.21 0 0 1-.32 1.65"></path>
          </svg>
        </Link>
        <div className="hero-text">
          <h1 className="hero-title">Johannes Fog</h1>
          <p className="hero-slogan">Holder i længden</p>
        </div>
      </div>
    </div>
  );
